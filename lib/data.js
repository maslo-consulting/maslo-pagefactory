...
export const services = [
  ...
  },
  {
    ...
    description: "End-to-end labour law compliance covering 18 statutory categories and all 4 new labour codes powered by MasloCompliance360 for companies in",
    ...
    faq: [
      ...
      { q: "What is MasloCompliance360?", a: "MasloCompliance360 is Maslo proprietary platform covering 18 statutory categories including EPF, ESI, POSH, and Professional Tax with an automated audit engine." },
      { q: "How do I check my compliance status?", a: "Run a free compliance audit via Maslo. The MasloCompliance360 platform identifies every gap and generates a prioritised action plan." },
      { q: "Is Professional Tax the same in all states?", a: "No. Professional Tax varies by state with different slabs and due dates. MasloCompliance360 maps all state-wise obligations automatically." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "What is Maslo Campus360?", a: "Maslo Campus360 is Maslo's AI-powered campus hiring network — pre-assessed, verified student profiles with a Candidate 360 score, plus structured AI interviews that generate evaluation reports automatically. It eliminates 80 percent of manual screening time." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is MasloLanguapro?", a: "MasloLanguapro is Maslo AI communication assessment platform measuring LSRW skills before and after training to prove ROI." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How does Maslo use AI?", a: "Maslo has 4 AI products: MasloLanguapro, Maslo SimuLead, MasloCompliance360, and Maslo Campus360. All are deployed in client engagements." },
